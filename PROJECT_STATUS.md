...
**Last updated:** 2026-06-11 (camera-traps: informe anual 2025 — nuevo análisis de distribución por gradiente ambiental. Se incorpora figura 7 (composite, 3 paneles: altitud, proximidad a caminos vehiculares, proximidad a cursos de agua) y Tabla 3 con % de eventos por especie en cada zona. Umbrales: 100 m para caminos y 100 m para agua (decisión basada en la geometría de la red de BP y respaldada por Forman & Alexander 1998, Forman 2000). Cada panel incluye línea base ("% de todos los eventos del informe en la zona destacada"; 61%/44%/16% para baja/cerca-camino/cerca-agua) como referencia interpretativa. Especies con n<5 se omiten de la figura y aparecen marcadas con † en la tabla. Nuevas referencias en bibliografía. Pendiente commit + push. **Pendiente integración pendiente:** ninguna; el script `03_compute_proximity.py` es diagnóstico opcional, no necesita correr para regenerar el informe.)
